-- Function: xt.parseediprofile(text, text)

-- DROP FUNCTION xt.parseediprofile(text, text);
...
$BODY$
  ...
  /**
   * This is the PEG.js generated EDI Profile parser code from:
   * TODO: URL
   * 
   ...
   *
   * 1. Modify the EDI Profile Grammer definition linked above.
   * 2. TODO: Add tests to example.
   * 3. Run the test in the old C++ EDI Profile parser and make sure it passes there.
   ...
   * 6. Run the EDI Profile test query through this function and ensure it passes.
   */
  var parser = (function() {
    /*
  ...
  /**
   * End of PEG.js generated EDI Profile parser code.
   */ 
   ...
   */
  try {
    editext += parser.parse(ediprofile, JSON.parse(options));
  } catch (err) {
    // Mimic mobilized XT.error() style error message.
    var message = {
      code: 500, 
      message: 'Cannot parse EDI Profile Tokens.'
    };
...
ALTER FUNCTION xt.parseediprofile(text, text)
  OWNER TO admin;
